...
/**
 * This is the model class for table "ref_filespace".
 *
 * The followings are the available columns in table 'ref_filespace':
 * @property string $id
 ...
 */
class RefFilespace extends XActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'diskOccupancies' => array(self::HAS_MANY, 'DiskOccupancy', 'filespace_id'),
	 ...
	 * @return RefFilespace the static model class
	 */
