...
/**
 * This is the model class for table "ref_logontype".
 *
 * The followings are the available columns in table 'ref_logontype':
 * @property string $id
 ...
 * @property User[] $users
 */
class RefLogontype extends XActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'users' => array(self::HAS_MANY, 'User', 'logon_type_id'),
		);
	}
	 ...
	 * @return RefLogontype the static model class
	 */
